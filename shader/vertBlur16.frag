...
void main(void)
{
	...
	//fragColor.rgb += blurWeight5 * texture2D(originalTexture, (fragCoord + vec2( 0.0, -4.0 )) * delta ).rgb;
	//fragColor.rgb += blurWeight4 * texture2D(originalTexture, (fragCoord + vec2( 0.0, -3.0 )) * delta ).rgb;
