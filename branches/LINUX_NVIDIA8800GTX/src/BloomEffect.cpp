...
BloomEffect::BloomEffect(int aTextureSize)
: iOriginalImageSize( aTextureSize )
#ifdef _DEBUG
, iCycleTextureOutput( 6 )
#else
...
GLuint BloomEffect::End()
{
	...
	return iOriginalTexture;
}

GLuint BloomEffect::ApplyEffect(GLuint aOriginalTexture, float* logSum)
{
	...
	iTextureLayers[0] = aOriginalTexture;
	...
	{
		OpenGLUtility::RenderSceneOnQuadMultiTex( &aOriginalTexture, 1 );
	}
	...
	case 0:
		{
			return aOriginalTexture; // original tex
		}
		break;
#ifdef _DEBUG
	case 1:
